...
export default function SheetPage({ userId }: SheetPageProps) {
  const sheetLink =
    "https://chromewebstore.google.com/detail/nkjnmccbdcbfkaheiajdjbkpafejakon?utm_source=item-share-cb";
  ...
  return (
    <div className="flex gap-3 px-2 items-center">
      ...
      <Link href={sheetLink} target="_blank" className="focus:outline-none">
        <Image
          src="/LOGO.png"
